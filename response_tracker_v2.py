...
from config import IMAP_SERVER, IMAP_USER, IMAP_PASS, TRACKED_DOMAINS, check_config
from deal_tracker import upsert_deal, get_deal, Stage, list_deals
        ...
        for num in search_data[0].split():
            ...
            if matched_deal:
                ...
                if self.auto_respond and current_stage in [Stage.PROSPECT, Stage.REPLIED]:
                    ...
                    from email_envoy_v2 import fire_reply_autoresponse
